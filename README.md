...
| **CPU (Linux RAPL)** | **LightGBM (GBDT)** | 8.650 | 231.96 | 223.31 | **34,954** | 182,747 | **6.6362** | **6.3887** | 1.07% | **measured RAPL saturated (end-to-end)** |
...
| DistilBERT ÷ LR | $\approx 19.78\times$ | $\approx 11.50\times$ |
| PubMedBERT ÷ LightGBM | $\approx 16.61\times$ | $\approx 9.47\times$ |
