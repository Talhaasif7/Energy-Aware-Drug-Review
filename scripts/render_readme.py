...
def generate_readme():
    ...
    lines.append("### 4. CADEC Label Harmonisation & Span Sensitivity Audit\n")
    lines.append(r"*Evaluating robustness against Brat ADR span-to-sentence mapping transformations on CADEC ($N=7{,}823$ sentences across 1,250 posts, 7,409 gold ADR spans, 0 missing annotations).*" + "\n")
    lines.append("| Model Tier | Recalibration | Rule A (Overlap) AUROC | Rule B (Contained) AUROC | Rule C (Post-Level) AUROC | Rule A ECE | Rule B ECE | Rule C ECE | Ranking Invariance |")
    lines.append("| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |")
    lines.append("| **Logistic Regression** | Uncalibrated | 0.8309 | 0.8307 | 0.8115 | 0.0924 | 0.0921 | 0.3107 | **Preserved** |")
    lines.append("| **Logistic Regression** | Temp Scaled ($T=0.72$) | 0.8309 | 0.8307 | 0.8115 | 0.0859 | 0.0857 | 0.2928 | **Preserved** |")
    lines.append("| **Logistic Regression** | Isotonic | 0.8266 | 0.8264 | 0.8111 | **0.0239** | **0.0237** | **0.1691** | **Preserved** |")
    lines.append("| **LightGBM (GBDT)** | Uncalibrated | 0.7801 | 0.7799 | 0.8280 | 0.0681 | 0.0679 | 0.2802 | **Preserved** |")
    lines.append("| **LightGBM (GBDT)** | Temp Scaled ($T=0.91$) | 0.7801 | 0.7799 | 0.8280 | 0.0650 | 0.0648 | 0.2819 | **Preserved** |")
    lines.append("| **LightGBM (GBDT)** | Isotonic | 0.7775 | 0.7773 | 0.8271 | 0.0563 | 0.0563 | 0.2113 | **Preserved** |")
    lines.append("| **DistilBERT** | Uncalibrated | 0.9170 | 0.9170 | 0.9422 | 0.0559 | 0.0556 | 0.0516 | **Preserved** |")
    lines.append("| **DistilBERT** | Temp Scaled ($T=1.33$) | 0.9170 | 0.9170 | 0.9423 | **0.0391** | **0.0389** | 0.0903 | **Preserved** |")
    lines.append("| **DistilBERT** | Isotonic | 0.9153 | 0.9153 | 0.9426 | **0.0230** | **0.0230** | 0.0813 | **Preserved** |")
    lines.append("| **PubMedBERT** | Uncalibrated | **0.9258** | **0.9258** | **0.9589** | 0.0606 | 0.0606 | **0.0213** | **Preserved** |")
    lines.append("| **PubMedBERT** | Temp Scaled ($T=1.58$) | **0.9258** | **0.9258** | **0.9591** | **0.0477** | **0.0477** | 0.0514 | **Preserved** |")
    lines.append("| **PubMedBERT** | Isotonic | **0.9247** | **0.9247** | **0.9545** | **0.0265** | **0.0267** | 0.0541 | **Preserved** |\n")
